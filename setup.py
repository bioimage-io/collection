...
_ = setup(
    ...
    install_requires=[
        "bioimageio.core @ git+https://github.com/bioimage-io/core-bioimage-io-python@bcf3f2cfd69c2ad2940fc533c8fe96c1a4cb76d1",  # TODO: change back to a released version
