...
_ = setup(
    ...
    install_requires=[
        "bioimageio.core @ git+https://github.com/bioimage-io/core-bioimage-io-python@e3e2a53738ba4b8820738fcc08e2600dd168ec5d",  # TODO: change back to a released version
        "bioimageio.spec==0.5.*",
        "fire",
        "loguru",
        "markdown",
