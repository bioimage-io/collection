...
def find_expected_output(outputs_dir, name):
    ...
    raise RuntimeError("Expected output for " + name + " not found")
    ...
    with open(os.path.join(model_dir, os.getenv("JSON_OUTS_FNAME")), "r") as f:
        ...
        for output in expected_outputs:
            ...
            if not os.path.exists(dij_output_path) or len(
                ...
                raise RuntimeError(
                    "Output " + name + " was not generated by deepimagej"
                )
            elif not os.path.exists(expected_output):
                raise RuntimeError("Cannot find expected output " + name)
            ...
            while dij_cursor.hasNext():
                ...
                if abs(
                    ...
                    raise RuntimeError("Values of output " + name + " differ")
